...
document.getElementById("changeTextButton").addEventListener("click",function (){
  ...
  para.textContent="Button clicked and parapagraph chnaged";
})

//example 2
document.getElementById("highlightFirstCity").addEventListener("click",function (){
  let ctl=document.getElementById("citiesList");
  let fc=ctl.firstElementChild;
...
document.getElementById("toggleHighlight").addEventListener("click",function (){
  let te=document.getElementById("descriptionText").classList.add("highlight");
  console.log(te);
})